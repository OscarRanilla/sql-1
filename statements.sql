...
--? PARA SABER QUE PERSONA SABE EM ESTE CASO JAVASCRIPT 
...
--? SELECT COUNT(DISTINCT edad) AS total_usuarios_java FROM usuarios_lenguajes WHERE lenguaje = 'Java';
...
--? SELECT nombre, apellido, COUNT(lenguaje) AS cantidad_lenguajes FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL GROUP BY nombre, apellido;
